...
public class BolandModat extends Account {


    public BolandModat(Double balance) {
    ...
    void Soud() throws SoudExp {
        System.out.println("mojodi:" + super.Mojodi );
        System.out.println("soud:" + ( 0.15 * super.Mojodi ) );
        super.Mojodi = (0.15 * super.Mojodi ) + super.Mojodi ;
